...
var Publish = (_dec = (0, _index3.connect)(function (store) {
  ...
  function Publish() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Publish.__proto__ || Object.getPrototypeOf(Publish)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["isEdit", "topicinfo", "cataData", "selectCata", "title", "content", "accesstoken"], _this.state = {
      selectCata: null,
      title: null,
      content: null,
      isEdit: false
  ...
  return Publish;
}(_index.Component), _class2.$$events = ["titleChange", "contentChange", "changeCata", "submitTopic"], _class2.$$componentPath = "pages/publish/publish", _temp2)) || _class);
