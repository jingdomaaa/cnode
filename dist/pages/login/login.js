...
var Login = (_dec = (0, _index3.connect)(function (store) {
  ...
  function Login() {
    ...
    }, _this.customComponents = ["Head"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Login, [{
    ...
    value: function loginToken() {
      if (this.state.token) {
        ...
        _index2.default.showToast({ title: '请输入秘钥再进行登录验证!', icon: 'none' });
      }
    }
  }, {
    key: "_createData",
  ...
  return Login;
}(_index.Component), _class2.$$events = ["changeToken", "loginToken"], _class2.$$componentPath = "pages/login/login", _temp2)) || _class);
