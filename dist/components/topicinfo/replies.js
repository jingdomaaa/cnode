...
var Replies = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Replies() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Replies.__proto__ || Object.getPrototypeOf(Replies)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray1", "replies", "user"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Replies, [{
    ...
    value: function admire(reply) {
      ...
      (0, _user.validateUser)(user).then(function (result) {
        if (result) {
          _this2.props.onAdmire && _this2.props.onAdmire(reply);
        }
      });
    }
  }, {
    ...
    value: function replyToReply(reply) {
      ...
      (0, _user.validateUser)(user).then(function (result) {
        if (result) {
          _this3.props.onReplyToReply && _this3.props.onReplyToReply(reply);
        }
      });
    }
  }, {
    ...
    value: function _createData() {
      ...
      var loopArray1 = replies.map(function (item, index) {
        item = {
  ...
  return Replies;
}(_index.Component), _class.$$events = ["admire", "replyToReply"], _class.$$componentPath = "components/topicinfo/replies", _temp2);
