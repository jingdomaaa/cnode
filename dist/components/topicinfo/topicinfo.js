...
var TopicInfo = (_temp2 = _class = function (_BaseComponent) {
  ...
  return TopicInfo;
}(_index.Component), _class.$$events = ["delTopic", "editTopic"], _class.$$componentPath = "components/topicinfo/topicinfo", _temp2);
