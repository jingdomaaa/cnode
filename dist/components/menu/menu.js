...
var Menu = (_dec = (0, _index3.connect)(function (store) {
  ...
  _createClass(Menu, [{
    ...
    key: "getdItems",
    value: function getdItems(cataData) {
    ...
    value: function _createData() {
      ...
      var items = this.getdItems(cataData); //获取分类列表
      var anonymousState__temp = "/assets/img/cata.png";
      var anonymousState__temp2 = "/assets/img/login.png";
  ...
  return Menu;
}(_index.Component), _class2.$$events = ["showDrawer", "toUser"], _class2.$$componentPath = "components/menu/menu", _temp2)) || _class);
