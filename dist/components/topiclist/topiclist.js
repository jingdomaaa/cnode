...
var TopicList = (_dec = (0, _index3.connect)(function (store) {
  ...
  function TopicList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TopicList.__proto__ || Object.getPrototypeOf(TopicList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray0", "list", "page", "limit", "currentCata", "getTopicList", "getNextList"], _this.customComponents = ["Topic"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(TopicList, [{
    ...
    value: function _createData() {
      ...
      var loopArray0 = list.map(function (item, _anonIdx) {
        ...
        var $compid__7 = (0, _index.genCompid)(__prefix + "ZRPCYulbaP" + _anonIdx);
  ...
  return TopicList;
}(_index.Component), _class2.$$events = ["onScrollToLower"], _class2.$$componentPath = "components/topiclist/topiclist", _temp2)) || _class);
