...
var Topic = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Topic() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Topic.__proto__ || Object.getPrototypeOf(Topic)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "item"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return Topic;
}(_index.Component), _class.$$events = ["goToDetail"], _class.$$componentPath = "components/topiclist/topic", _temp2);
